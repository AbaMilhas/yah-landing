        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="relative group">
            ...
            <div className="absolute inset-0 rounded-2xl bg-gradient-to-b 
                    from-[#8B4DFF]/30 via-[#6A2BCB]/10 to-transparent 
                    opacity-60 group-hover:opacity-100 transition-opacity duration-300" />

            {/* Conteúdo */}
            <div className="relative flex h-full flex-col gap-3 rounded-2xl 
                 bg-white/[0.04] px-5 py-6 shadow-[0_14px_38px_rgba(0,0,0,0.45)]
                 transition-transform duration-300 group-hover:-translate-y-1">
              
              <span className="inline-flex h-8 w-8 items-center justify-center rounded-full 
                     bg-[#8B4DFF]/20 text-xs font-semibold text-[#C9A6FF]">
                01
              </span>
          ...
          <div className="relative group">
            ...
            <div className="relative flex h-full flex-col gap-3 rounded-2xl 
              ...
              <p className="text-sm text-slate-200 leading-relaxed">
                ...
                com milhas — suporte completo do time Yah.
              </p>
            </div>
          </div>
        </div>
